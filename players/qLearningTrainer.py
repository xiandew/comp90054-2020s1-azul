...
class myPlayer(AdvancePlayer):
    ...
    #     new_state = self.MakeAMove(game_state, selected_move)
    ...
    #     self.agent.update_replay_memory((current_state, selected_move, reward, new_state, done))
    #     # train the model
    #     self.agent.train(done)

    #     self.agent.model.save(f'DQNModelVer1.model')
    ...
    #     return next(filter(lambda ps: ps.id == self.id, game_state.players))
